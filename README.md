...
An Android side-display app for showing Spotify playback, album art, and real Codex usage on a tablet or phone.

一个 Android 侧屏应用，用来在平板或手机上展示 Spotify 当前播放、专辑封面和 Codex 真实用量。
